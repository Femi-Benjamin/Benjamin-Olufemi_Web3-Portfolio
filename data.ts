...
export const projects: Project[] = [
  // Original Projects
  {
    ...
    description:
      "A high-performance decentralized trading interface aggregating liquidity for optimal swap rates.",
    longDescription:
    ...
    screenshots: [
      defiExchangeProImage,
      cryptoPortfolioTrackerImage,
      gasFeeEstimatorImage,
    ],
    category: "web3",
  ...
  },
  {
    ...
    title: "MY WEB3 HUB",
    description:
      "A comprehensive Web3 dashboard for tracking crypto assets and exploring decentralized applications.",
    ...
    category: "web3",
    highlights: [
      "Real-time crypto asset tracking",
      "Decentralized application explorer",
      "Dapp Integration",
    ],
  },
  {
    ...
    description:
      "Gas-optimized marketplace for minting and trading ERC-721 assets on Ethereum Sepolia.",
    longDescription:
      "Empowering creators with a zero-fee minting platform. This marketplace supports lazy minting to lower entry barriers, an auction system with real-time bidding, and robust metadata management using IPFS. The UI focuses on showcasing digital art with immersive layouts and smooth transitions.",
  ...
  //   description:
  //     "Comprehensive voting interface for decentralized organizations, featuring quadratic voting.",
  //   longDescription:
  //     "A governance hub for DAOs to manage proposals, treasury, and voting. It introduces quadratic voting to prevent whale dominance and integrates with Snapshot for gasless off-chain voting. The dashboard provides deep analytics into voter participation and proposal outcomes.",
  ...
  // },
  {
    ...
    description:
      "AI-powered analysis tool identifying vulnerabilities and gas optimizations in Solidity code.",
    longDescription:
      "Leveraging LLMs to secure smart contracts. This tool accepts Solidity code, parses it, and runs it against a fine-tuned model to detect common vulnerabilities like Reentrancy and Overflow. It generates detailed PDF reports with remediation steps and gas optimization tips.",
  ...
  },
  {
    ...
    description:
      "A personal portfolio website showcasing projects and skills with modern UI.",
    ...
    highlights: [
      ...
      "Showcase of Web3 and Frontend projects",
    ],
  },
  {
    id: 26,
    title: "PACEPLOYT",
    description:
      "A premium corporate website for Paceployt, showcasing multidisciplinary expertise across tech, business consulting, and real estate.",
    longDescription:
      "Paceployt is a high-impact parent conglomerate platform representing core business pillars including a flagship tech agency, corporate consulting, and premier real estate. The application features a stunning modern dark-themed landing page with smooth micro-animations, glassmorphic UI components, and fully responsive layouts.",
    tags: ["React Js", "TailwindCSS", "Framer Motion", "TypeScript"],
    repoUrl: "https://github.com/Femi-Benjamin/paceployt",
    liveUrl: "https://www.paceployt.i.ng/",
    image: paceployt,
    category: "frontend",
    role: "Frontend Developer",
    stack: ["React", "TypeScript", "TailwindCSS", "Framer Motion"],
    highlights: [
      "Designed a modern and visually stunning landing page matching the conglomerate's premium brand",
      "Created dynamic section transitions and interactive pillar showcases",
      "Ensured pixel-perfect responsiveness across all screen sizes",
    ],
  },
  {
    id: 15,
    title: "SPENDWISE",
    description:
      "Your personal finance companion for tracking expenses, budgeting, and financial planning.",
    tags: ["React Js", "Typescript", "TailwindCSS"],
    repoUrl:
  ...
  },
  {
    ...
    description:
      "3D virtual land explorer integrated with Decentraland registry data.",
    longDescription:
      "An immersive 3D map interface for exploring and purchasing virtual land. Users can fly over parcels, view ownership history, and place bids. Built with Three.js and React Three Fiber for a seamless in-browser 3D experience.",
  ...
  },
  {
    ...
    description:
      "Secure asset bridge between Ethereum, BSC, and Solana with proof-of-stake validation.",
    longDescription:
      "Facilitating seamless asset transfers across fragmented blockchains. This bridge uses a lock-and-mint mechanism securitized by a decentralized set of validators. The UI prioritizes trust and clarity, showing users exactly where their funds are at every step of the cross-chain journey.",
  ...
  //   description:
  //     "Decentralized identity verification system using zk-SNARKs for privacy-preserving authentication.",
  ...
  // },
  {
    ...
    description:
      "Real-time portfolio tracker supporting 50+ chains with historical performance visualization.",
  ...
  // },
  {
    ...
    description:
      "Browser extension and web app to predict optimal transaction times to save on gas fees.",
  ...
  // New Projects
  {
    ...
    title: "FAITH VAULT",
    description:
      "A secure digital vault application for managing digital assets and sensitive information.",
  ...
  },
  {
    ...
    title: "TITAN LEAP",
    description:
      "A dynamic landing page and platform for Titan Leap, showcasing services and offerings.",
    tags: ["React Js", "Typescript", "TailwindCSS"],
  ...
  },
  {
    ...
    description:
      "A beauty and wellness platform specifically designed for hair treatment services.",
  ...
  },
  {
    ...
    description:
      "A modern e-commerce user interface for an online fashion and accessories store.",
    tags: ["React Js", "TailwindCSS"],
  ...
  //   description:
  //     "A travel agency website offering tour packages and destination guides for arctic adventures.",
  //   tags: ["React Js", "TailwindCSS"],
  ...
  // },
  {
    ...
    description:
      "A comprehensive system for managing patient records, appointments, and hospital resources.",
  ...
  },
  {
    ...
    description:
      "An educational platform facilitating online learning with courses and interactive content.",
  ...
  },
  {
    ...
    title: "Cardify",
    description:
      "A digital card generation and management application with cloud integration.",
