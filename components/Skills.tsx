...
const SkillIcon: React.FC<{ name: string; className?: string }> = ({
  ...
  switch (name) {
    ...
    case "TypeScript":
      return (
        <div
          className={`${className} bg-[#3178C6] rounded-sm text-white font-bold text-[10px] flex items-center justify-center`}
        >
          TS
        </div>
      );
    case "Next.js":
      return (
        ...
        >
          <path
            d="M12 2C6.47 2 2 6.47 2 12s4.47 10 10 10 10-4.47 10-10S17.53 2 12 2zm0 18c-4.41 0-8-3.59-8-8 0-4.41 3.59-8 8-8 4.41 0 8 3.59 8 8 0 4.41-3.59 8-8 8zm-1-13h2v10h-2zm-3 3h2v7h-2zm6-3h2v10h-2z"
            fill="transparent"
          />
    ...
    case "Tailwind CSS":
      return (
        ...
        >
          <path
            d="M11.25 7.5C9.75 3.75 5.25 3.75 3.75 7.5C2.25 11.25 6 13.5 6 13.5C6 13.5 8.25 14.25 9.75 16.5C11.25 18.75 14.25 19.5 16.5 16.5C18.75 13.5 15.75 10.5 15.75 10.5C15.75 10.5 12.75 11.25 11.25 7.5Z"
            stroke="currentColor"
            strokeWidth="1.5"
            strokeLinecap="round"
          ...
          />
          <path
            d="M18.75 7.5C17.25 3.75 12.75 3.75 11.25 7.5"
            stroke="currentColor"
            strokeWidth="1.5"
            strokeLinecap="round"
            strokeLinejoin="round"
    ...
    case "Solidity":
      return (
        ...
        >
          <path
            d="M12 2L12.5 3.5L20 7L12 12L4 7L11.5 3.5L12 2Z"
            stroke="currentColor"
            strokeWidth="1.5"
          />
          <path
            d="M12 22L12.5 20.5L20 17L12 12L4 17L11.5 20.5L12 22Z"
            stroke="currentColor"
            strokeWidth="1.5"
          />
        </svg>
    ...
    case "Hardhat":
      return (
        <div className={`${className} bg-yellow-500 rounded-full w-4 h-4`} />
      );
    case "IPFS":
      return <Box className={`${className} text-teal-500`} />;
    case "GraphQL":
